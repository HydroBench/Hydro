       ...
       real *q, real *dq, real *c, real *qxm, real *qxp)
{
  ...
  real zerol = 0.0, zeror = 0.0, project = 0.;
...
#pragma acc loop independent
    ...
    real cc, csq,r, u, v, p;
    real dr, du, dv, dp;
    real alpham, alphap, alpha0r, alpha0v;
    real spminus, spplus, spzero;
    real apright, amright, azrright, azv1right;
    real apleft, amleft, azrleft, azv1left;
