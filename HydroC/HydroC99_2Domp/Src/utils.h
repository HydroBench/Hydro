...
void printarray(FILE * fic, real_t * a, int n, const char *nom,
		const hydroparam_t H);
void printarrayi(FILE * fic, int *a, int n, const char *nom);
void printarrayv(FILE * fic, real_t * a, int n, const char *nom,
		 const hydroparam_t H);
void printarrayv2(FILE * fic, real_t * a, int n, const char *nom,
		  const hydroparam_t H);
