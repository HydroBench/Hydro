...
#define MOVEPAGE(t)
    ...
    Hvw->q = Hvw->u + domainVarM;
    touchPage(Hvw->q, domainVar);
    Hvw->dq = Hvw->q + domainVarM;
    touchPage(Hvw->dq, domainVar);
    Hvw->qxm = Hvw->dq + domainVarM;
    touchPage(Hvw->qxm, domainVar);
    Hvw->qxp = Hvw->qxm + domainVarM;
    touchPage(Hvw->qxp, domainVar);
    Hvw->qleft = Hvw->qxp + domainVarM;
    touchPage(Hvw->qleft, domainVar);
    Hvw->qright = Hvw->qleft + domainVarM;
    touchPage(Hvw->qright, domainVar);
    Hvw->qgdnv = Hvw->qright + domainVarM;
    touchPage(Hvw->qgdnv, domainVar);
    Hvw->flux = Hvw->qgdnv + domainVarM;
    touchPage(Hvw->flux, domainVar);
    Hw->e = Hvw->flux + domainVarM;
    touchPage(Hw->e, domain);
    Hw->c = Hw->e + domainM;
    touchPage(Hw->c, domain);
    Hw->pstar = Hw->c + domainM;
    touchPage(Hw->pstar, domain);
    Hw->rl = Hw->pstar + domainM;
    touchPage(Hw->rl, domain);
    Hw->ul = Hw->rl + domainM;
    touchPage(Hw->ul, domain);
    Hw->pl = Hw->ul + domainM;
    touchPage(Hw->pl, domain);
    Hw->cl = Hw->pl + domainM;
    touchPage(Hw->cl, domain);
    Hw->rr = Hw->cl + domainM;
    touchPage(Hw->rr, domain);
    Hw->ur = Hw->rr + domainM;
    touchPage(Hw->ur, domain);
    Hw->pr = Hw->ur + domainM;
    touchPage(Hw->pr, domain);
    Hw->cr = Hw->pr + domainM;
    touchPage(Hw->cr, domain);
    Hw->ro = Hw->cr + domainM;
    touchPage(Hw->ro, domain);
#else
    /*
    ...
    MOVEPAGEVAR(Hvw->qleft);
    Hvw->qright = DMalloc(domainVar);
    MOVEPAGEVAR(Hvw->qright);
    Hvw->qgdnv = DMalloc(domainVar);
    MOVEPAGEVAR(Hvw->qgdnv);
    Hvw->flux = DMalloc(domainVar);
    MOVEPAGEVAR(Hvw->flux);
    //
    Hw->e = DMalloc(domain);
    MOVEPAGE(Hw->e);
    Hw->c = DMalloc(domain);
