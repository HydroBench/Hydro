...
class Tile {
 private:
    ...
    void constprimOnRow(int32_t xmin, int32_t xmax, Preal_t qIDS, Preal_t qIPS,
			Preal_t qIVS, Preal_t qIUS, Preal_t uIDS, Preal_t uIPS,
			Preal_t uIVS, Preal_t uIUS, Preal_t eS);
    void constprim();		// fait
    ...
    void riemannOnRowInRegs(int32_t xmin, int32_t xmax, real_t smallp,
    ...
    void riemann();		// fait
    void compute_dt_loop2OnRow(real_t & tmp1, real_t & tmp2, int32_t xmin,
			       int32_t xmax, Preal_t cS, Preal_t qIUS,
			       Preal_t qIVS);
    void compute_dt_loop1OnRow(int32_t xmin, int32_t xmax, Preal_t qIDS,
			       Preal_t qIPS, Preal_t qIUS, Preal_t qIVS,
			       Preal_t uoldIDS, Preal_t uoldIUS,
			       Preal_t uoldIVS, Preal_t uoldIPS, Preal_t eS);
    real_t compute_dt();
    void gatherconservXscan(int32_t xmin, int32_t xmax, Preal_t uIDS,
    ...
    void updateconservYscan(int32_t s, int32_t xmin, int32_t xmax, int32_t ymin,
			    int32_t ymax, real_t dtdx,
    ...
    // utilities on tile
    void getExtends(tileSpan_t span, int32_t & xmin, int32_t & xmax,
 ...
 public:
    ...
    void initPhys(real_t gamma, real_t smallc, real_t smallr, real_t cfl,
    ...
    void setExtend(int32_t nx, int32_t ny, int32_t gnx, int32_t gny,
