...
class ThreadBuffers {
  ...
  public:
    ...
    Soa *getQ() { return m_q; };
    Soa *getQXM() { return m_qxm; };
    Soa *getQXP() { return m_qxp; };
    Soa *getDQ() { return m_dq; };
    ...
    // work arrays for a single row/column
    real_t *getPSTAR() { return m_pstar; };
    real_t *getRL() { return m_rl; };
    real_t *getUL() { return m_ul; };
    real_t *getPL() { return m_pl; };
    real_t *getUR() { return m_ur; };
    real_t *getPR() { return m_pr; };
    real_t *getCL() { return m_cl; };
    real_t *getCR() { return m_cr; };
    real_t *getRR() { return m_rr; };
    long *getGOON() { return m_goon; };
    real_t *getSGNM() { return m_sgnm; };
};
#endif
// EOF
